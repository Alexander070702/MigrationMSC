...
.mdc-deprecated-chip-trailing-action:focus {
  opacity: 1;
}
...
.smui-chip-input.smui-chip-input--disabled .mdc-deprecated-chip-trailing-action {
  display: none;
}
.smui-chip-input .smui-chip-input__chip-set {
  padding: 0;
  gap: 8px;
}
.smui-chip-input .smui-chip-input__chip-set .mdc-chip {
  margin: 0;
}
.smui-chip-input .smui-chip-input__autocomplete {
  flex-grow: 1;
}
.smui-chip-input .smui-chip-input__textfield {
  width: 100%;
}
.smui-chip-input .smui-chip-input__loading {
  display: flex;
  width: 100%;
  justify-content: center;
  align-items: center;
