...
.mdc-switch.smui-switch--color-secondary {
  ...
  --mdc-switch-selected-focus-handle-color: rgb(1, 67.5, 67.0037313433);
  --mdc-switch-selected-focus-state-layer-color: var(--mdc-theme-secondary, #018786);
  --mdc-switch-selected-focus-track-color: rgb(162.1875, 254.3125, 253.625);
  --mdc-switch-selected-handle-color: var(--mdc-theme-secondary, #018786);
  --mdc-switch-selected-hover-handle-color: rgb(1, 67.5, 67.0037313433);
  --mdc-switch-selected-hover-state-layer-color: var(--mdc-theme-secondary, #018786);
  --mdc-switch-selected-hover-track-color: rgb(162.1875, 254.3125, 253.625);
  --mdc-switch-selected-icon-color: var(--mdc-theme-on-secondary, #fff);
  --mdc-switch-selected-pressed-handle-color: rgb(1, 67.5, 67.0037313433);
  --mdc-switch-selected-pressed-state-layer-color: var(--mdc-theme-secondary, #018786);
  --mdc-switch-selected-pressed-track-color: rgb(162.1875, 254.3125, 253.625);
  --mdc-switch-selected-track-color: rgb(162.1875, 254.3125, 253.625);
